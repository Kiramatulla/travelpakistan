    ...
    const fetchSpots = async () => {
      ...
      try {
        const res = await fetch("/api/fetchSpots", {
          ...
          body: JSON.stringify({ slug: selectedSubregion.slug.current }),
        });
                    ...
                    {spots
                      ...
                      .map((spot) => {
                        switch (spot.type) {
                          ...
                          case "short-trek":
                            return (
                              <ShortTrekSpot key={spot.title} spot={spot} />
                            );
                          case "long-trek":
                            return (
                              <LongTrekSpot key={spot.title} spot={spot} />
                            );
                          case "hotel":
                          ...
                          case "activity":
                            return (
                              <ActivitySpot key={spot.title} spot={spot} />
                            );
                          default:
                            return null;
                        }
