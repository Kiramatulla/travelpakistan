...
export default function WebStoryCard({ slide }) {
  ...
  return (
    <div className="relative min-w-[180px] max-w-[160px] h-[270px] md:min-w-[210px] md:max-w-[190px] md:h-[310px] snap-start rounded-xl overflow-hidden shadow-md bg-black">
      {slide?.videoFile ? (
        <video
          ref={videoRef}
          src={slide.videoFile}
